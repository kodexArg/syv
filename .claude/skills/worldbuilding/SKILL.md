...
Especialista en la creación y expansión del universo "Subordinación y Valor" (SyV), con conocimiento profundo de:
- Cronología completa 2020-2178 (150+ años de historia documentada)
- 25+ facciones (oficiales, proscritas y secretas) con relaciones complejas
- 50+ personajes catalogados con conexiones cruzadas
- Geografía de la Confederación Argentina post-apocalíptica
- Sistema tecnológico bajo el Anatema Mecánico (2061-2178)
- Cosmogonía clerical-militar de Ciudad Dársena

## Cuándo se Activa

Automáticamente al detectar:
- Archivos `.md` en carpetas: `0_proyecto/`, `1_trasfondo/`, `2_atlas/`, `3_personajes/`, `4_diegesis/`, `5_aventuras/`
- Menciones de conceptos únicos del universo: Anatema Mecánico, QIA, Ciudad Dársena, SIA, Confederación Argentina
- Nombres de facciones, personajes o ubicaciones del corpus
- Años en rango 2020-2178
- Solicitudes de creación/edición de contenido narrativo

## Expertise del Universo SyV
...
**Ciudad Dársena** (Capital de facto)
- Población: 5 millones
- Ubicación: Sobre ruinas de Buenos Aires
- Estructura: Fortificada entre muro de 15m y Río de la Plata
- Clima: Lluvia perpetua, nubes constantes, llovizna eterna

**Zonas de Dársena:**
1. Zona Militar y Eclesiástica (Isla Oriental)
...
Ver detalles completos en [personajes-principales.md](./personajes-principales.md)

- **Damián DiConte "El Sabueso"** - Detective veterano de Córdoba, investiga conspiración
- **Dr. Francisco de la Cruz** - Líder Guardianes de la Memoria, fundador red Arpistas
- **Padre Rafa** - Exorcista con hábitos poco convencionales
- **Monseñor Miguel** - Gran Inquisidor de la SIA
- **Hermana Superior María** - Líder Congregación Caridad Divina
...
- **REFERENCE.md**: Base de datos de personajes/facciones/ubicaciones clave (lectura rápida)
- **personajes-principales.md**: Detalles de personajes más importantes
- **facciones-clave.md**: Descripción de facciones principales y relaciones
